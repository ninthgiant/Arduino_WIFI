...
// Enable post-flash MD5 end-to-end verification. Adds a few seconds at the
// end of each flash (ESP32 hashes the written region; we compare against our
// streamed hash). Worth the cost — guarantees the chip contents match source.
